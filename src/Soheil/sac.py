...
with imageio.get_writer("video/sac_agent.mp4", fps=60) as video:
    terminal = True
    states = env.reset()
...
# Define a 3 joint hand in pybullet (or maybe Mujuco)
# create synthetic data / or use the offline data from human motion lab
